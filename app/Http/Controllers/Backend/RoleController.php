        ...
        if ($request->ajax()) {
            ...
            return DataTables::of($query)
                ...
                ->addColumn('action', function (Permission $permission) {
                    ...
                    $deleteForm = '
        <form method="POST" action="'.route('permission.destroy', $permission->id).'" class="forms-sample d-inline">
            '.csrf_field().method_field('DELETE').'
            <a href="'.route('permission.edit', $permission->id).'" class="action-btn btn-edit bs-tooltip me-2"
                data-toggle="tooltip" data-placement="top" title="Edit" data-bs-original-title="Edit">
            ...
            <button type="submit" class="btn btn-inverse-light border-0 bg-white btn-submit">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
