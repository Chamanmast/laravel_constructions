<x-front-layout>
	...
	$jobs = App\Models\JobPosition::select('name', 'image')->active(0)->get();
	...
	->first();
	$modal17 = App\Models\Module::select('heading', 'image', 'small_text')->find(17);
	$modal18 = App\Models\Module::select('heading', 'image', 'small_text')->find(18);
	$modal19 = App\Models\Module::select('heading', 'image', 'small_text')->find(19);
	$modal20 = App\Models\Module::select('heading', 'image', 'small_text')->find(20);
    @endphp
    @section('main')
		...
		<div class="container pb-15 pb-md-17">
		  <div class="row gx-md-5 gy-5 mt-n18 mt-md-n19">
			<div class="col-md-6 col-xl-3">
			  <div class="card lift">
				<div class="card-body">
				  <img src="{{asset('frontend/assets/img/icons/lineal/target.svg')}}" class="svg-inject icon-svg icon-svg-sm solid-mono text-primary mb-3" alt="" />
				  <h4>Career Growth</h4>
			...
			<div class="col-md-6 col-xl-3">
			  <div class="card lift">
				<div class="card-body">
				  <img src="{{asset('frontend/assets/img/icons/lineal/videocall.svg')}}" class="svg-inject icon-svg icon-svg-sm solid-mono text-primary mb-3" alt="" />
			...
			<div class="col-md-6 col-xl-3">
			  <div class="card lift">
				<div class="card-body">
				  <img src="{{asset('frontend/assets/img/icons/lineal/wallet.svg')}}" class="svg-inject icon-svg icon-svg-sm solid-mono text-primary mb-3" alt="" />
				  <h4>Smart Salary</h4>
				  <p class="mb-0">Nulla vitae elit libero, a pharetra augue. Donec id elit non mi porta gravida at eget metus cras justo.</p>
				</div>
				<!--/.card-body -->
			...
			<div class="col-md-6 col-xl-3">
			  <div class="card lift">
				<div class="card-body">
				  <img src="{{asset('frontend/assets/img/icons/lineal/alarm.svg')}}" class="svg-inject icon-svg icon-svg-sm solid-mono text-primary mb-3" alt="" />
		  ...
		  <div class="row gy-10 gy-sm-13 gx-md-8 gx-xl-12 align-items-center mt-12">
			<div class="col-lg-6">
			  <div class="row gx-md-5 gy-5">
				<div class="col-12">
				  <figure class="rounded mx-md-5"><img src="{{asset('frontend/assets/img/photos/g8.jpg')}}" srcset="{{asset('frontend/assets/img/photos/g8@2x.jpg')}} 2x" alt=""></figure>
				</div>
				<!--/column -->
				<div class="col-md-6">
				  <figure class="rounded"><img src="{{asset('frontend/assets/img/photos/g9.jpg')}}" srcset="{{asset('frontend/assets/img/photos/g9@2x.jpg')}} 2x" alt=""></figure>
				</div>
				<!--/column -->
				<div class="col-md-6">
				  <figure class="rounded"><img src="{{asset('frontend/assets/img/photos/g10.jpg')}}" srcset="{{asset('frontend/assets/img/photos/g10@2x.jpg')}} 2x" alt=""></figure>
				</div>
				<!--/column -->
			  </div>
			  <!--/.row -->
			  ...
			  <div class="row gy-8">
				<div class="col-md-6">
				  <div class="d-flex flex-row">
					<div>
					  <img src="{{asset('frontend/assets/img/icons/lineal/share.svg')}}" class="svg-inject icon-svg icon-svg-xs solid-mono text-primary me-4" alt="" />
					</div>
					<div>
				...
				<div class="col-md-6">
				  <div class="d-flex flex-row">
					<div>
					  <img src="{{asset('frontend/assets/img/icons/lineal/partnership.svg')}}" class="svg-inject icon-svg icon-svg-xs solid-mono text-primary me-4" alt="" />
					</div>
					<div>
