                                        ...
                                        <tr class="cat-{{ $cat->id }}">
                                            ...
                                            <td class="text-center">
                                                <div class="action-btns">
                                                    ...
                                                    <a href="{{ route('blogcategory.edit', $cat->id) }}"
                                                    ...
                                                    <a href="javascript:void(0)"
                                                        onClick="deleteFunction({{ $cat->id }},'Blogcategory')"                                                        
            ...
            if (checkedValues.length === 0) {
                ...
                checkboxes.forEach(function(checkbox) {
                    ...
                    if (checkbox.checked) {
                        // Add the value to the array
                        checkedValues.push(checkbox.value);
                        var elems = document.querySelector('.cat-' + checkbox.value);
                        elems.remove();
                    }
                });
                // console.log("Checked Checkbox Values: ", checkedValues);
                var crf = '{{ csrf_token() }}';
                $.post("{{ route('blogcategory.delete') }}", {
                    _token: crf,
                    id: checkedValues,
                    table: table
                }, function(data) {
