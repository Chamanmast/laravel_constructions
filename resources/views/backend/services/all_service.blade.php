            ...
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                <div class="statbox widget box box-shadow">
                    <div class="widget-content widget-content-area">
                                ...
                                @foreach ($services as $service)
                                    <tr class="service-{{ $service->id }}">
                                        ...
                                        <td style="width:1%"><span class="form-check form-check-primary">
                                                <input class="form-check-input mixed_child " value="{{ $service->id }}"
                                        ...
                                        <td>@php
                                            if (!empty($service->image)) {
                                               ...
                                               # $small_img = $img[0] . '_photo.' . $img[1];
                                               $small_img =$service->image;
                                            } else {
                                        ...
                                        <td class="text-center">
                                            <button type="button"
                                                onClick="statusFunction( {{ $service->id }} ,'Service')"
                                        ...
                                        <td class="text-center">
                                            <div class="action-btns">
                                                ...
                                                <a href="javascript:void(0)"
                                                    onClick="deleteFunction({{ $service->id }},'Service')"
                        ...
                        @if ($services->count() != 0)
                            <div class="ms-3">
                                <button id="deleteall" onClick="deleteAllFunction('service')"
                ...
                document.querySelector('.delete' + id).addEventListener('click', function() {
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            var elems = document.querySelector('.service-' + id);
                            elems.remove();
                            var crf = '{{ csrf_token() }}';
                            $.post("{{ route('services.delete') }}", {
                                _token: crf,
