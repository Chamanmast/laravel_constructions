...
>>>>>>> Stashed changes
		...
		<div class="col-6">
            ...
            <div class="mb-3">
                ...
                <x-form.select name="brands[]" :options="$brands" :selected="isset($service) ? explode(',', $service->brands) : []" multiple
				class="taggings" /><x-form.input-error :messages="$errors->get('brands')" class="mt-2" />
			</div>
		</div>
	</div>
    <div class="row">
