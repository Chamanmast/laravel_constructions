            ...
            <div class="blog grid grid-view">
                ...
                <div class="row isotope gx-md-8 gy-8 mb-8">
                    @foreach ($blogs as $blog)
                        ...
                        @endphp
                        <x-blog.single :category="$blog->category->category_name" :title="$blog->post_title" :$slug :image="$small_img" :text="Str::limit($blog->short_descp, '450', '....')"
                            :created="$blog->created_at->format('M d, Y')" :user="$blog->user?->name">
