        ...
        <div class="card">
            <div class="card-body">
                <div class="row">
                    ...
                    <form method="POST" action="{{ route('login') }}" class="text-left login-form needs-validation" id="login" novalidate = "novalidate">
                        @csrf

                    <div class="col-md-12">
                        <div class="mb-3">
                            <x-form.input-label for="username" :value="__('Username')" />
                            <x-form.text-input id="username"
                            ...
                            <x-form.input-error :messages="$errors->get('username')" class="invalid-feedback" />
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="mb-4">
                    ...
                    <div class="col-12">
                        <div class="mb-4">
                            ...
                            <x-form.primary-button name="submit" class="loginButton btn btn-secondary w-100">
